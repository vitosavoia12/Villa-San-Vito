...
const translations = {
  en: {
    ...
    "nav.book": "Reserve",
    "hero.eyebrow": "Amalfi Coast",
    "hero.title": "The stay you were looking for",
    "hero.subtitle": "Set in Raito, the small balcony of the Amalfi Coast that many pass by, our house welcomes visitors with the best charms of Mediterranean life: slow hours, garden aromas, sea air.",
    ...
    "photos.title": "Postcards from a house that feels like home",
  ...
  es: {
    ...
    "nav.book": "Reservar",
    "hero.eyebrow": "Costa Amalfitana",
    "hero.title": "El alojamiento que estabas buscando",
    "hero.subtitle": "Ubicada en Raito, el pequeño balcón de la Costa Amalfitana que muchos pasan de largo, nuestra casa recibe al visitante con los mejores encantos de la vida mediterránea: horas que pasan lentas, aromas de jardín, aire de mar.",
    ...
    "photos.title": "Postales de una casa que es hogar",
    ...
    "booking.title": "Reserva en tus plataformas de confianza",
    ...
    "instagram.copy": "También puedes encontrar vistas recientes y momentos cotidianos en",
  ...
  it: {
    ...
    "nav.book": "Prenota",
    "hero.eyebrow": "Costiera Amalfitana",
    "hero.title": "Il soggiorno che cercavi",
    "hero.subtitle": "Situata a Raito, il piccolo balcone della Costiera Amalfitana che molti lasciano da parte, la nostra casa accoglie gli ospiti con i migliori incanti della vita mediterranea: ore lente, profumi di giardino, aria di mare.",
    ...
    "photos.title": "Cartoline da una casa che sa di casa",
