...
const translations = {
  it: {
    ...
    "location.copy": "Raito si trova sulle alture di Vietri sul Mare, in una zona tranquilla da cui la Costiera Amalfitana comincia ad aprirsi verso il Golfo di Salerno.",
    "location.copy2": "Da qui si possono visitare Vietri, Salerno, Amalfi, Ravello o Positano durante il giorno, e tornare nel tardo pomeriggio alla calma del borgo. La posizione esatta viene condivisa al momento della prenotazione.",
  ...
  es: {
    ...
    "location.copy": "Raito se encuentra en las alturas de Vietri sul Mare, en una zona tranquila desde donde la Costa Amalfitana empieza a abrirse hacia el Golfo de Salerno.",
    "location.copy2": "Desde acá se puede visitar Vietri, Salerno, Amalfi, Ravello o Positano durante el día, y volver al final de la tarde a la calma del pueblo. La ubicación exacta se comparte al momento de la reserva.",
  ...
  en: {
    ...
    "location.copy": "Raito sits in the heights of Vietri sul Mare, in a quiet area where the Amalfi Coast begins to open toward the Gulf of Salerno.",
    "location.copy2": "From here you can visit Vietri, Salerno, Amalfi, Ravello or Positano during the day, then return by late afternoon to the calm of the village. The exact location is shared at the time of booking.",
